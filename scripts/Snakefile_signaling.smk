# Simulations and figure generation for Figure 3 in the paper:
#   Signaling model simulations for three exercise protocols
#
# Sensitivity analysis is run separately and not included here.
#
# Run script as:
#   $ snakemake -s scripts/Snakefile_signaling.smk --use-conda --cores 1
...
rule generateFigure3:
    input:
        ...
        sa_results=RESULTS_DIR
        / "SA/sensitivity_analysis_parallel_N=10000_order=2/ST.csv",
